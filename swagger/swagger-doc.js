...
const estateRouteDocs = require('./estateDoc');
...
const options = {
  definition: {
    ...
    servers: [
      ...
      {
        url: 'https://expensive-jade-pants.cyclic.app/',
    ...
    tags: [
      ...
      {name: 'Real Estate', description:'Listing'},
    ...
    paths: { ...userRouteDocs, ...contactRouteDocs, ...blogRouteDocs, ...estateRouteDocs},
  },
  apis: ['../routes/**/*.js'],
};
